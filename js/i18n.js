...
(function () {
  ...
  const dict = {
    ...
    'Carica estratto conto': 'Upload bank statement',
    'Transazioni estratte': 'Extracted transactions',
    'Avvia matching': 'Start matching',
    'Genera report': 'Generate report',
    'Approva tutto': 'Approve all',
    'Non identificata': 'Unidentified',
    'Transazione': 'Transaction',
    'Importo': 'Amount',
    'Banca riconosciuta': 'Bank detected',
    'Formato non riconosciuto': 'Format not recognized',
    'Seleziona un cliente': 'Select a client',
    'Trascina qui il file o clicca per caricare': 'Drag file here or click to upload',
    // ── Riconciliazione (completamento) ──
    'Upload, parsing e matching automatico dei bank statement': 'Upload, parsing and automatic matching of bank statements',
    'Cerca...': 'Search...',
    'Scegli un cliente dalla lista per iniziare la riconciliazione': 'Choose a client from the list to start the reconciliation',
    'Gen': 'Jan',
    'Mag': 'May',
    'Giu': 'Jun',
    'Lug': 'Jul',
    ...
    'Ott': 'Oct',
    'Dic': 'Dec',
    'CSV, Excel (.xlsx) o PDF • Il formato della banca viene riconosciuto automaticamente': 'CSV, Excel (.xlsx) or PDF • The bank format is detected automatically',
    'Nessuna transazione trovata': 'No transactions found',
    'Debiti:': 'Debits:',
    'Crediti:': 'Credits:',
    'Debito': 'Debit',
    'Credito': 'Credit',
    ...
    'Ripristina': 'Restore',
    'Avvia Matching': 'Start Matching',
    'Cliente senza Zoho Org ID': 'Client without Zoho Org ID',
    'Approva tutti >90%': 'Approve all >90%',
    'Genera Report': 'Generate Report',
    'Esporta CSV per Zoho': 'Export CSV for Zoho',
    'Seleziona prima un cliente': 'Select a client first',
    'Formato non supportato. Usa CSV, Excel (.xlsx) o PDF.': 'Unsupported format. Use CSV, Excel (.xlsx) or PDF.',
    'Lettura file': 'Reading file',
    'Analisi AI del PDF': 'AI analysis of the PDF',
    'Upload su storage': 'Upload to storage',
    'Salvataggio transazioni': 'Saving transactions',
    'Aggiornamento registro': 'Updating register',
    'Riconoscimento banca': 'Bank detection',
    'Parsing transazioni': 'Parsing transactions',
    'Salvataggio nel database': 'Saving to database',
    'Lettura file PDF...': 'Reading PDF file...',
    'Analisi AI in corso — potrebbe richiedere 20-30 secondi...': 'AI analysis in progress — this may take 20-30 seconds...',
    'Salvataggio transazioni nel database...': 'Saving transactions to the database...',
    'Aggiornamento registro...': 'Updating register...',
    'Lettura file...': 'Reading file...',
    'Riconoscimento formato banca...': 'Detecting bank format...',
    'Nessuna transazione trovata nel file. Controlla il formato.': 'No transactions found in the file. Check the format.',
    'Salvataggio nel database...': 'Saving to the database...',
    'Eliminare questo upload e tutte le transazioni associate?': 'Delete this upload and all associated transactions?',
    'Upload eliminato': 'Upload deleted',
    'Seleziona un cliente e un upload': 'Select a client and an upload',
    'Questo cliente non ha un Zoho Organization ID. Configuralo in Setup Zoho.': 'This client does not have a Zoho Organization ID. Configure it in Zoho Setup.',
    'Matching in corso...': 'Matching in progress...',
    'Recupero dati da Zoho Books...': 'Fetching data from Zoho Books...',
    'Nessuna transazione da matchare (tutte già processate)': 'No transactions to match (all already processed)',
    'Transazione approvata': 'Transaction approved',
    'Transazione ignorata': 'Transaction ignored',
    'Transazione ripristinata': 'Transaction restored',
    'Nessuna transazione ad alta confidenza da approvare': 'No high-confidence transactions to approve',
    'Nessuna transazione da importare': 'No transactions to import',
    'Nessuna transazione non identificata da inserire nel report': 'No unidentified transactions to include in the report',
    'Popup bloccato. Abilita i popup per questo sito.': 'Popup blocked. Enable popups for this site.',
